...
<body>
  <div class="container">
    ...
    <div class="controls-section">
      ...
      <div class="controls-grid">
        <button type="button" class="btn-control" id="btn-prev-slide">
          <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polyline points="15 18 9 12 15 6"></polyline>
          </svg>
          Previous Slide
        </button>
        <button type="button" class="btn-control" id="btn-next-slide">
          Next Slide
          <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polyline points="9 18 15 12 9 6"></polyline>
          </svg>
        </button>
        <button type="button" class="btn-control" id="btn-reload">
          <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <h3>Speaker Notes Controls</h3>
      <div class="controls-grid">
        <button type="button" class="btn-control" id="btn-notes-zoom-in">
          <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <button type="button" class="btn-control" id="btn-notes-zoom-out">
          <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <circle cx="11" cy="11" r="8"></circle>
            <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
            <line x1="8" y1="11" x2="14" y2="11"></line>
        ...
        <button type="button" class="btn-control" id="btn-notes-scroll-up">
          <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <polyline points="18 15 12 9 6 15"></polyline>
          </svg>
          Scroll Up
        </button>
        <button type="button" class="btn-control" id="btn-notes-scroll-down">
          <svg class="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <script>
    ...
    document.getElementById('btn-notes-zoom-in').addEventListener('click', () => {
      apiCall('/api/zoom-in-notes');
    });
    
    document.getElementById('btn-notes-zoom-out').addEventListener('click', () => {
      apiCall('/api/zoom-out-notes');
    });
    
    document.getElementById('btn-notes-scroll-up').addEventListener('click', () => {
      apiCall('/api/scroll-notes-up');
    });
    
    document.getElementById('btn-notes-scroll-down').addEventListener('click', () => {
    ...
    form.addEventListener('submit', (e) => {
      ...
      fetch(API_BASE + '/api/presets', {
        ...
        .catch(err => {
          ...
          showStatus('Failed to save presets: ' + err.message + ' (Make sure the app is running)', true);
        });
    });
  </script>
</body>
